...
if uploaded_file:
    ...
    presets = {
        ...
        "PPD302": {"dec_global": 180, "CH1": 0, "CH2": 180, "CH3": 0, "CH4": 180},
    }
    ...
    # Appliquer preset comme valeur par défaut des sliders
    ...
    axs[2].axis("off")
    axs[2].text(0.5,0.5, f"PPD: {ppd_selected} | Durée {n} ms | {rpm:.1f} RPM | Global {dec_global}° | {txt}", ha="center", va="center")
