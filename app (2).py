...
# --- DOSSIER SOURCE ---
# Utiliser I: si monté, sinon UNC visible (sans $)
BASE_DIR = r"I:\400-Echange_OT\03-Rapports\WPMS"
# BASE_DIR = r"\\netapp10\wpms_data\400-Echange_OT\03-Rapports\WPMS"  # alternative UNC
...
try:
    ...
    files = sorted(files, key=lambda x: os.path.getmtime(os.path.join(BASE_DIR, x)), reverse=True)
...
start, end = indices_fronts[cycle_num], indices_fronts[cycle_num+1]
